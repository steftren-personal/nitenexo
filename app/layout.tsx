...
export const metadata: Metadata = {
  ...
  description:
    "NiteNexo Solutions baut Websites, digitale Gäste-Tools und Automatisierungen für Gastronomie, Bars und Clubs. Reservierungen, Anfragen und Gästelisten — digital und unkompliziert.",
};
