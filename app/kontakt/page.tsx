      ...
      <div style={{ background: "var(--surface-canvas-light)", color: "var(--ink)", minHeight: "100vh" }}>
        <div style={{ maxWidth: "var(--container-max)", margin: "0 auto", padding: "var(--space-xxl) var(--space-xl) var(--space-section)" }}>
          <div style={{ textAlign: "center", maxWidth: 620, margin: "0 auto var(--space-xxl)" }}>
            <Eyebrow polarity="light">Kontakt</Eyebrow>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-xl)" }}>
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-sm)" }}>
                  <a href={`mailto:${CONTACT.email}`} style={{ font: "var(--type-heading-sm)", color: "var(--color-ink-deep)", textDecoration: "none" }}>
                    {CONTACT.email}
                  </a>
                  <a href={CONTACT.phoneHref} style={{ font: "var(--type-heading-sm)", color: "var(--color-ink-deep)", textDecoration: "none" }}>
                    {CONTACT.phone}
                  </a>
                </div>
              </div>
              <div>
                ...
                <p style={{ font: "var(--type-body-md)", color: "var(--color-ink-deep)", margin: 0, lineHeight: 1.6 }}>
                  {CONTACT.name}
                  <br />
                  {CONTACT.street}
                  <br />
              ...
              <div style={{ background: "var(--surface-canvas-dark)", color: "var(--on-primary)", borderRadius: "var(--rounded-xl)", padding: "var(--space-xl)" }}>
